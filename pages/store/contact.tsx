    ...
    <div className="min-h-screen bg-tech-white text-tech-gray-800 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 pt-16">
        <div className="w-full max-w-md">
          ...
          <p className="font-mono text-xs text-tech-gray-800 tracking-wide mb-8">Get in touch — we&apos;d love to hear from you.</p>
          <form
            onSubmit={async (e) => {
              e.preventDefault();
          ...
          >
            ...
            <div>
              <label className="font-mono text-xs tracking-widest text-tech-gray-800 block mb-2">MESSAGE</label>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="font-mono text-xs text-tech-gray-800 tracking-wide leading-relaxed">
